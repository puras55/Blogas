...
public class RssFeedController {
  ...
  public Channel rssFeed(HttpServletRequest request) {
    ...
    channel.setUri(baseUrl);                                    //Iš pradžių metodas gauna pagrindinį URL iš užklausos, ir jį naudoja kaip pagrindą kuriant nuorodas į atskirus įrašus.
                                                         //Tada yra sukuriamas Channel objektas, kuris atstovauja RSS srautą.
  ...
  //galimybę vartotojams prenumeruoti jūsų blogo įrašus per RSS srautą.
